(() => {
    ...
    var e = {
        438: (e, t, n) => {
            ...
            l.push([e.id, "@import url(https://fonts.googleapis.com/css2?family=Nanum+Gothic+Coding&amp;family=Roboto+Mono:wght@100;400&amp;display=swap);"]);
            var d = r()(o.Z),
                g = r()(c.Z);
            l.push([
                e.id,
                ...
                return (
                    ...
                    (t.i = function (e, n, i) {
                        ...
                        for (var o = 0; o < e.length; o++) {
                            var c = [].concat(e[o]);
                            (i && s[c[0]]) || (n && (c[2] ? (c[2] = "".concat(n, " and ").concat(c[2])) : (c[2] = n)), t.push(c));
                        }
                    }),
                    t
                );
        ...
        379: (e, t, n) => {
            ...
            function o(e, t) {
                for (var n = {}, i = [], s = 0; s < e.length; s++) {
                    ...
                    -1 !== g ? (a[g].references++, a[g].updater(h)) : a.push({ identifier: d, updater: I(h, t), references: 1 }), i.push(d);
                }
                return i;
            }
            function c(e) {
            ...
            function I(e, t) {
                ...
                if (t.singleton) {
                    var a = u++;
                    (n = m || (m = c(t))), (i = g.bind(null, n, a, !1)), (s = g.bind(null, n, a, !0));
                } else
                    (n = c(t)),
                        (i = h.bind(null, n, t)),
                        (s = function () {
    ...
    (n.n = (e) => {
        ...
        (() => {
            const e = " ",
                t = (t, n) => (t || "").padEnd(n, e),
                i = class {
                    constructor(t, { count: n, size: i, delay: s, theme: a }) {
                        (this.options = { delay: s || 250, theme: a }), (this.size = i), (this.messages = new Array(n).fill("".padEnd(this.size, e))), this._createElement(t), this._createTickers(), this.update();
                    }
                    _createElement(e) {
                        const t = document.createElement("ul");
                        if ((t.classList.add("board"), "string" == typeof e && (e = document.querySelector(e)), e instanceof HTMLElement && e.replaceWith(t), "string" == typeof this.options.theme)) {
                            const { theme: e } = this.options;
                            t.setAttribute(e, !0);
                        }
                        this.element = t;
                    }
                    _createTickers() {
                        this.tickers = this.messages.map((e, t) => this.setupTicker(t));
                    }
                    updateCount(t) {
                        if (t !== this.tickers.length) {
                            for (; t > this.tickers.length;) this.messages.push("".padEnd(this.size, e)), this.tickers.push(this.setupTicker(this.tickers.length));
                            for (; t < this.tickers.length;) this.tickers.pop();
                        }
                    }
                    setupTicker(t) {
                        const n = new (class {
                            constructor(t, n) {
                                (this.size = t), (this.message = n.padEnd(t, e)), (this.delay = 200), (this.cards = this.createCards()), (this.element = this.render());
                            }
                            updateMessage(t) {
                                (this.message = t.padEnd(this.size, e)), this.changeMessage();
                            }
                            changeMessage() {
                                let t = this.message.replace(/\s/g, e);
                                this.cards.forEach((e, n) => {
                                    setTimeout(() => e.animateTo(t[n]), n * this.delay);
                                }),
                            ...
                            createCards() {
                                return new Array(this.size).fill("").map(
                                    () =>
                                        new (class {
                                            constructor(e) {
                                                (this.visibleLetter = e), this.createElement();
                                            }
                                            createElement() {
                                                (this.element = document.createElement("span")), this.element.classList.add("ticker"), (this.element.innerText = this.visibleLetter);
                                            }
                                            changeCharacter(e) {
                                                (this.visibleLetter = e), this.render();
                                            }
                                            animateTo(e) {
                                                if (this.visibleLetter === e) return;
                                                const t =
                                                    ((n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789:,'- "),
                                                        (i = this.visibleLetter),
                                                        (s = e),
                                                        (function (e, t) {
                                                            return e.slice(0, e.indexOf(t) + 1);
                                                        })(
                                                            (function (e, t) {
                                                ...
                                                const r = (n) => {
                                                    ...
                                                    const i = n - a,
                                                        s = Math.floor(i / 25);
                                                    s < t.length ? (this.changeCharacter(t[s]), window.requestAnimationFrame(r)) : (this.changeCharacter(e), this.element.classList.remove("animating"));
                                                };
                                                this.element.classList.add("animating"), window.requestAnimationFrame(r);
                                            }
                                            render() {
                            ...
                            render() {
                                ...
                                return (
                                    ...
                                    t.classList.add("ticker-row"),
                                    this.screenReaderElement.classList.add("sr-only"),
                                    this.cards.forEach((e) => {
                                        t.appendChild(e.element);
                                    }),
                                    e.append(this.screenReaderElement, t),
                                    e
                                );
                            }
                        })(this.size, this.messages[t].padEnd(this.size, e));
                        return this.element.appendChild(n.element), n;
                    }
                    update() {
                        this.tickers.forEach((e, n) => {
                            (this.messages[n] = t(this.messages[n], this.size)), setTimeout(() => e.updateMessage(this.messages[n]), n * this.options.delay);
                        });
                    }
                    updateMessages(e) {
                        var t, n;
                        (this.messages = ((t = e), "", (n = this.tickers.length) <= t.length ? t : t.concat(new Array(n - t.length).fill("")))), this.update();
                    }
                },
                s = class extends i {
                    constructor(e, n) {
                        super(e, n),
                            (this.defaultMessage = new Array(n.size).fill(" ").join("")),
                            (this.originalMessages = n.messages.map((e) => t(e, this.size))),
                            (this.delay = n.delay || 8e3),
                            (this.initialDelay = n.initialDelay || 1e3),
                            this.rotate();
                    }
                    rotate() {
                        setTimeout(() => {
                            this.advance(), (this.interval = setInterval(this.advance.bind(this), this.delay));
                        }, this.initialDelay);
                    }
                    cancel() {
                    ...
                    advance() {
                        const e = Array.from(this.messages);
                        e.shift();
                        const t = this.messages[this.messages.length - 1],
                            n = this.originalMessages.indexOf(t) + 1;
                        e.push(this.originalMessages[n]), this.updateMessages(e);
                    }
                };
            var a = n(379),
                r = n.n(a),
            ...
            r()(o.Z, { insert: "head", singleton: !1 }),
                ...
                window &&
                ((window.Board = i),
                    (window.TickerBoard = class {
                        constructor(e, t) {
                            const { size: n, theme: i, delay: a } = t || {},
                                r = document.querySelectorAll(e);
                            this.boards = Array.from(r).map((e) => {
                                const t = Array.from(e.children).map((e) => e.innerText),
                                    r = document.createElement("ul");
                                e.replaceWith(r);
                                const o = new s(r, { count: t.length, size: n || Math.max(...t.map((e) => e.length)), messages: t, theme: i, delay: a });
                                return o.element.addEventListener("click", () => o.advance()), o;
                            });
                        }
                        advance(e) {
                            this.boards[e].advance();
                        }
                    }),
                    (window.RotationBoard = s));
        })();
})();
